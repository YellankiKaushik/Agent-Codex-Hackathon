...
5. Confirm cards for Mastra, Qdrant, Featherless AI, Enkrypt AI, OpenAI fallback, OpenRouter fallback, Gemini, Langfuse, Upstash, and optional Supabase fallback.
...
| OpenAI/OpenRouter fallback | `/debug/integrations` OpenAI and OpenRouter cards plus fallback badge behavior                            |
...
- It reasons over report explanations and Vigilance alert reasons through Featherless AI, with OpenAI/OpenRouter/local fallback.
