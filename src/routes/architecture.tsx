...
const layers = [
  ...
  {
    layer: "Reasoning",
    technology: "Featherless AI + OpenAI/OpenRouter fallback",
    purpose:
      ...
      <main className="mx-auto max-w-6xl px-4 py-12">
        <section className="rounded-lg border border-border bg-card p-5 shadow-sm sm:p-6">
          ...
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-muted-foreground">
            ...
            Qdrant retrieval and memory, Gemini embeddings, Featherless AI reasoning,
            OpenAI/OpenRouter fallback, Enkrypt validation, Langfuse tracing, and Upstash rate
            limiting. The core report path is simple: Qdrant retrieves, Featherless reasons, and
            Enkrypt validates before display.
          </p>
