  ...
  head: () => ({
    meta: [
      { title: "Integrations status - SchemeSeva" },
      {
        name: "description",
        content:
          "Live status of the SchemeSeva stack: Mastra adapter, Featherless AI, OpenAI, OpenRouter, Gemini embeddings, Qdrant, Enkrypt AI, Langfuse, Upstash, and optional Supabase fallback.",
      },
    ],
  }),
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="min-w-0">
              ...
              <p className="mt-3 max-w-3xl text-xs font-semibold uppercase tracking-wide text-primary">
                ...
                validation, Featherless AI reasoning, OpenAI/OpenRouter fallback, Gemini embeddings,
        ...
        {isLoading && !data ? (
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-2">
            ...
            <Card
              ...
              badges={[
                ...
                <Pill
                  ...
                  label={
                    data.featherless.credentialsSet ? "credentials set" : "credentials missing"
                  }
                />,
                <Pill
                  key="m"
            ...
            <Card
              ...
              primary={data.openai.configured}
              badges={[
                <Pill
                  key="k"
                  ok={data.openai.configured}
                  label={data.openai.configured ? "configured" : "fallback inactive"}
                />,
                <Pill
                  key="d"
                  ok={data.demoMode}
            ...
            >
              <p className="text-sm text-muted-foreground">
                Fallback model: <code>{data.openai.model ?? "not set"}</code>. Profile extraction,
                report fallback, Vigilance alert reasons, and fallback safety validation prefer
                OpenAI when <code>OPENAI_API_KEY</code> is configured.
              </p>
            </Card>
            ...
            >
              <p className="text-sm text-muted-foreground">
                ...
                Featherless and OpenAI are unavailable.
              </p>
            </Card>
